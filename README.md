<div align="center">
  <img src="assets/header-3d.svg" alt="Mohammad Pooshesh — AI Engineer · GeoAI · RAG · Knowledge Graphs · MCP" width="100%"/>
</div>
...
| <img src="https://cdn.simpleicons.org/javascript/5E9FE8" width="18" alt="Javascript"/>   | **[ai-atlas](https://github.com/mohammadpooshesh/ai-atlas)** | Interactive, fully client-side 3D atlas of 60 AI algorithms — live simulations, math, code & quizzes · | `JavaScript` `WebGL` `PWA` |

## Telemetry · 3D contribution skyline

<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="assets/contrib-3d-dark.svg"/>
    <img src="assets/contrib-3d-light.svg" alt="Isometric 3D contribution skyline — every bar is a day, height = contributions" width="100%"/>
  </picture>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="assets/contrib-stats-dark.svg"/>
    <img src="assets/contrib-stats-light.svg" alt="Contribution stats — total, active days, streaks, best day" width="100%"/>
  </picture>
  <sub>Hand-crafted isometric 3D render of real contribution data — generated by <a href="scripts/gen-contrib-3d.mjs"><code>scripts/gen-contrib-3d.mjs</code></a> and served from this repo, so it's theme-aware and <strong>always loads</strong>.</sub>
</div>

<!--
Snake animation — uncomment after enabling workflows-setup/snake.yml (see workflows-setup/README.md):
<picture>
...
<p align="center">
  <sub>Profile rendered in <code>EPSG:4326</code> · 3D skyline built from real commit telemetry</sub>
</p>
