...
| | **[ai-atlas](https://github.com/mohammadpooshesh/ai-atlas)** | Interactive, fully client-side 3D atlas of 60 AI algorithms — live simulations, math, code & quizzes · **[Live demo →](https://mohammadpooshesh.github.io/ai-atlas/)** | `JavaScript` `WebGL` `PWA` |
